...
cl %compiler_flags% %includes% ..\apps\two_circles.c -LD -MT -D_URSDLL /link %linker_flags% -EXPORT:get_callbacks -EXPORT:load_assets -EXPORT:init_app -EXPORT:update_and_render /out:two_circles.dll
